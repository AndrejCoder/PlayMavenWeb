...
import ru.lanit.component.DateFilteredPropertyColumn;
import ru.lanit.dao.DaoException;
import ru.lanit.dao.StudentDao;
import ru.lanit.models.Group;
import ru.lanit.models.Student;
import ru.lanit.providers.SortableStudentDataProvider;
...
public class StudentPanel extends Panel {
    ...
    public StudentPanel(String id, IModel<Group> selectedGroup) {
        ...
        List<IColumn<Student, String>> studentColumns = new ArrayList<IColumn<Student, String>>();
